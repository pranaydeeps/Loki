...
def main():
    ...
    features = featuresdf[["hero", "villain", "victim", "other",  'Negative_siebert', 'Neutral_siebert', 'Positive_siebert']] 
    ...
    ExtraTreesClassifier(bootstrap=True, criterion="entropy", max_features=0.55, min_samples_leaf=1, min_samples_split=15, n_estimators=100)
)
